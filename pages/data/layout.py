...
def upload_card(
    header: str, text: str, id: str, allow_multiple: bool = True
) -> html.Div:
    ...
    card = html.Div(
        ...
        children=[
            ...
            html.Div(className="card-body row", children=[upl]),
        ],
    )
    return card
...
def get_layout():
    ...
    upload_cards = html.Div(
        ...
        children=[
            upload_card(
                "Load Campaign",
                "Restore a previous campaign from .mocca2 file",
                "data-upload-campaign",
                allow_multiple=False,
            ),
            upload_card(
                "Select Blank",
                "Select the chromatogram with gradient only to use as blank",
                "data-upload-blank",
                allow_multiple=False,
            ),
            upload_card(
                "Upload Sample",
                "Select the chromatogram data for analysis",
                "data-upload-sample",
            ),
        ],
    )
    ...
    table_header = html.H3(
        "Please add information about the uploaded chromatograms", className="mt-5"
    )
    ...
    choose_istd = html.Div(
        ...
        style={"display": "flex", "gap": "2ch", "margin": "0.5rem 0"},
    )
    ...
    buttons_log = html.Span(id="data-span-buttons-message", className="")
